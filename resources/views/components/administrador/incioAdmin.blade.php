                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$striper->correo}}</td>
                            <td><img class="img-thumbnail" src="{{asset($striper->foto)}}" alt="no hay foto..."></td>
                            <td> 
                                  <a href=""><button type="button" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
